...
export const saveCurrencyPair = async (req: Request, res: Response<StandardResponse<CurrencyPair>>) => {
    try {
...
export const getCurrencyPairsByUser = async (req: Request, res: Response<StandardResponse<CurrencyPair[]>>) => {
    try {
...
export const getCurrencyPairsById = async (req: Request, res: Response<StandardResponse<CurrencyPair>>) => {
    try {
        const {id} = req.params;
...
export const deleteCurrencyPairById = async (req: Request, res: Response<StandardResponse<null>>) => {
    try {
        const {id} = req.params;
