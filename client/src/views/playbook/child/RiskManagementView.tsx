import {Button, Dialog, DialogContent, DialogTitle, Input, Slider, TextField} from "@mui/material";
...
export const RiskManagementView: React.FC = () => {
    ...
    const [guideLinesList, setGuideLinesList] = useState([{
        id: 1, description: "Never risk more than 1-2% of your account on a single trade."
    }, {id: 2, description: "Always use stop-loss orders to limit potential losses."}, {
        id: 3, description: "Maintain a positive risk-reward ratio, aiming for at least 1:2."
    }, {id: 4, description: "Diversify your trades across different assets and strategies."}, {
        id: 5, description: "Regularly review and adjust your risk management approach."
    },]);
    ...
    const handleAddGuideline = () => {
        if (newGuideline.trim()) {
            const newGuidelineItem = {
                id: guideLinesList.length + 1, description: newGuideline,
            };
    ...
    return (<div className="min-h-screen py-[1vw]">
        <div className="flex items-center justify-between bg-gray-50 p-[1.5vw] rounded-lg shadow-sm">
            <div>
                ...
                <p className="text-gray-600 mt-[0.5vw]">
                    Effective risk management is crucial for successful trading. These guidelines and tools will
                    help you make informed decisions and protect your capital.
                </p>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[2vw] py-5">
            ...
            <div className="rounded max-w-7xl shadow-lg">
                <div className="p-6 flex items-center justify-between border-b">
                    ...
                    <Button size="small" variant="outlined" onClick={() => handleModel(true)}>
                ...
                <div className="p-6 pt-4 space-y-2 h-[70%] overflow-y-auto">
                    <div className="list-disc">
                        {guideLinesList.map((element) => (<div
                            key={element.id}
            ...
            <div className="rounded max-w-7xl shadow-lg">
                ...
                <div className="px-6 py-4">
                    <div className="space-y-4">
                        <div>
                            <h1 className="text-sm font-medium text-gray-500">Account Size</h1>
                            <Input
                                id="accountSize"
                                type="number"
                                value={accountSize}
                        ...
                        <div>
                            <h1 className="text-sm font-medium text-gray-500">Stop-Loss Level</h1>
                            <Input
                                id="stopLoss"
                                type="number"
                                value={stopLoss}
                        ...
                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-sm">
                                ...
                                <span className="font-bold text-blue-600">{maxRisk.toFixed(2)}</span>
                            </p>
                            <p className="text-sm">
                                Suggested position size:{" "}
                                <span
                                    className="font-bold text-blue-600">{suggestedPositionSize.toFixed(2)} units</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="rounded max-w-7xl shadow-lg">
                <div className="p-6 border-b">
                    <h2 className="text-xl font-bold text-gray-800">Take Profit Calculator</h2>
                </div>
                <div className="px-6 py-4">
                    <div className="space-y-4 flex flex-col justify-between">
                        <div>
                            <h1 className="text-sm font-medium text-gray-500">Target Profit</h1>
                            <Input className="mt-1 w-full"/>
                        </div>
                        <div>
                            <h1 className="text-sm font-medium text-gray-500">Risk-Reward Ratio</h1>
                            <Slider min={0} max={5} step={0.1} className="mt-2"/>
                            <span className="text-sm text-gray-600">1</span>
                        </div>

                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                            <h3 className="text-lg font-semibold mb-2">Optimal Take-Profit</h3>
                            <p className="text-sm">
        ...
        <Dialog open={openModal} onClose={() => handleModel(false)} maxWidth="sm" fullWidth>
            ...
            <DialogContent>
                ...
                <div className="flex justify-end mt-4">
                    <Button onClick={() => handleModel(false)} color="secondary" className="mr-2">
                        Cancel
                    </Button>
                    <Button
                        color="primary"
